...
namespace Servidor
{
    public class ServerProgram
    {
        public static async Task Main(string[] args)
        {
            ...
            Server server = new Server(listener, new Service(new Repository()));
        ...
        private static void CreateClient(Server server)
        {
            Console.Clear();
            Console.WriteLine("ADMINISTRACIÓN DEL SERVIDOR" + "\n\nCREACIÓN DE CLIENTE");
        ...
        private static void DeleteClient(Server server)
        {
        ...
        private static void ModifyClient(Server server)
        {
        //    var clients = server.Service.GetAllClients();
        //    string[] options = clients.Select(g => g.ToString()).ToArray();
